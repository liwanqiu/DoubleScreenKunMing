...
import com.changfeng.tcpdemo.socketclient.helper.HeartBeatHelper;
import com.changfeng.tcpdemo.socketclient.helper.PollingHelper;
import com.changfeng.tcpdemo.socketclient.helper.SocketInputReader;
import com.changfeng.tcpdemo.socketclient.helper.SocketPacket;
import com.changfeng.tcpdemo.socketclient.helper.SocketPacketHelper;
import com.changfeng.tcpdemo.socketclient.helper.SocketResponsePacket;
import com.changfeng.tcpdemo.socketclient.util.CharsetNames;
import com.changfeng.tcpdemo.socketclient.util.ExceptionThrower;
import com.changfeng.tcpdemo.socketclient.util.StringValidation;
...
public class SocketClient {
    ...
    public static final int DefaultConnectionTimeout = 1000 * 30;
...
//                e.printStackTrace();
    ...
    public SocketClient registerSocketDelegate(SocketDelegate delegate) {
        //不包含delegate则添加进去，返回socketclient对象
...
//        消息种类
    ...
    private class ConnectionThread extends Thread {
        ...
        public void run() {
            ...
            try {
                //找到运行的socket进行连接，然后发送消息到UI线程
                //InetSocketAtaddress是JAVA类，实现了soxketAddress类，捆绑服务端数据
